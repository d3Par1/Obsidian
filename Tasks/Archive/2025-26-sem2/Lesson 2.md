---
course: Практичний курс іноземної мови. Частина 2
type: завдання
due: 2026-03-09
status: done
year: 2
...
**Курс:** Практичний курс іноземної мови. Частина 2

## Вкладення

- ▶ Introducing Petcube Cam - All-new Affordable Pet Camera With a Built-in Vet Chat
- 📎 B1-B2 Discover Ukraine Future Made by Ukrainians SV.pdf
- 📎 Miro

## Google Classroom

[Відкрити завдання](https://classroom.google.com/u/0/c/ODQ0NzYyNDIwMjcx/a/ODQ0ODc3NDcxMDQ2/details)
...
Spot the Connection
Look at the pictures. Work in pairs or small groups.
What do these images have in common? 
Note down your ideas. Then go to the next slide to check if you were right.
   Useful phrases:
I think they all show...
Maybe the connection is...
It looks like they’re all about...
I’m not sure. Could it be...?
Do you think it might be...?
Our idea is that they’re all connected to...
Licence issued for personal use, 131782, Daria Shchipachova

  Which of these apps (Grammarly, BetterMe, Petcube, Reface, Diia, WhatsApp) have become 
  popular outside Ukraine?
  Why do you think Ukrainian tech has been noticed around the world?
  Which Ukrainian app is the most useful for everyday life, in your opinion?
  Have you heard of any Ukrainian apps or inventions before this lesson? Which ones?
  Do you think Ukraine is more famous for culture, food or technology? Why?
Let’s discuss
...
Petcube
BetterMe
Guess the Ukrainian Innovation
Work in pairs or small groups. Look at the sets of clue words below. Each set describes a Ukrainian app or innovation.
Try to guess what the app does, then match it with the correct name. Use the useful phrases to explain your choice.
      Useful phrases:
It could be about...
Maybe it has been designed for...
I think it matches... because...
From my point of view, it must be...
We agree, it has been used for...
...
Licence issued for personal use, 131782, Daria Shchipachova
 ...
 1. Work in pairs or small groups. Discuss these questions before watching.
  3. Read the text. Which three facts do you find most surprising? 
  Underline them and share your ideas with a partner or group.
  2. After watching the video, work in pairs or small groups. 
  Write down three words that best describe Petcube.
Watch, Play, Feed!
1.What problems do pet owners have when they leave their pets alone at home?
2.If you could invent a device for pets, what would it do?
3.Which of these things would you want most: to watch your pet / to talk to your pet / to
play with your pet / to give your pet food?
Petcube is a smart device that was created in Kyiv in 2012 by three Ukrainian friends. They had a
dog that often felt lonely when they were at work, so they decided to design something new.
The first Petcube allowed owners to watch their pets through a small camera and even play with
them using a built-in laser pointer. Later versions have included a microphone and a speaker, so
people can talk to their pets, and some models can even throw treats remotely.
Petcube has quickly grown from a small start-up into an international company. Today, its
products have been sold in more than 18 countries and are especially popular in the United States.
Many pet owners say it has made life easier and more fun, both for them and for their animals.
Petcube has also helped to show the world that Ukraine is a centre of creative and useful
technology.
      Useful phrases:
I was surprised that...
It’s interesting that...
From my point of view, the most unusual fact is...
Licence issued for personal use, 131782, Daria Shchipachova

 1. Work in pairs or small groups. Think about problems that pets or owners still have. 
  Write down two or three ideas.
 2. Choose one problem from your list and imagine a new feature for Petcube that solves it.
 3. Create a short, catchy slogan (max. 7 words) to advertise your upgraded Petcube.
 4. Present your feature and slogan in 1 minute. After all presentations, vote for:
Petcube – Upgrade & Advertise
What the feature does: _____________________________________________________________________
How it works: _____________________________________________________________________________
Why it is useful: ___________________________________________________________________________
Examples: “Playtime, anytime” / “Because pets deserve more”.
 Most useful feature: _____________________________________________________________________
 Funniest idea: __________________________________________________________________________
 Best slogan: ____________________________________________________________________________
Bailey, stop!
Licence issued for personal use, 131782, Daria Shchipachova

 1. Work in pairs or small groups. First, watch the video about common spelling struggles, then 
 discuss the questions below.
2. Read the text and discuss: Why do you think so many people use Grammarly today?
3. Decide if the sentences below are True or False. Correct the False ones.
Grammarly is a writing assistant that was created in 2009 by three Ukrainians: Alex Shevchenko, Max
Lytvyn and Dmytro Lider. At first, the software helped students check their essays and avoid mistakes.
Later, it became popular with professionals who needed to write clear emails and reports. Grammarly
can correct grammar, spelling and vocabulary errors, but it also suggests how to improve style and
tone. The app works as a website, a browser extension and a mobile app, so people can use it almost
anywhere. Today, Grammarly has more than 30 million daily users and has become one of the 
best-known Ukrainian tech products worldwide.
HELPING MILLIONS WRITE BETTER
1.Have you ever forgotten how to spell a simple word? Which one?
2.What problems do people usually have when writing in English?
3.How do you usually check your writing?
1.Grammarly was created in 2009 by three Ukrainians. ____________
2.At first, Grammarly was mainly used by professionals. ____________
3.The app only corrects spelling mistakes. ____________
4.Today, more than 30 million people use Grammarly every day. ____________
Licence issued for personal use, 131782, Daria Shchipachova

 1. Work in pairs or small groups. Look at the “tweets” below. They all contain mistakes. Pretend you are Grammarly: correct each one and explain what the 
 mistake is.
2. Work in pairs or small groups. Imagine Grammarly is a person who keeps a diary. 
Write 4–5 short sentences beginning with “Today I have corrected...”. Use your imagination to make it funny or surprising.
Be the App!
17k25075
I feeled so happy when my team
win yesterday!!!
17k25075
Is it “seperate” or “separate”? I’ve
writed both in my essay.
17k25075
I can’t beleive I’ve finnaly passed
the egzams!!!
17k25075
How do you spell “tomatoe”? I
googled it 5 times already...
Examples: 
Dear Diary, today I have stopped three arguments about “their / there / they’re”. Humans never learn.
Dear Diary, today I have fixed 20 essays where people wrote “I feeled happy”. I’m so tired.
Licence issued for personal use, 131782, Daria Shchipachova

HEALTHY HABITS, BETTER ME
 1. Work in pairs or small groups. Read the health habits below. Put them in order from the one you do most often (1) to the one you do least (5). 
